...
import ProfilePic from '../assets/img/nav/p_pic.jpeg';
import Messenger from '../assets/img/nav/messenger.svg';
import Bell from '../assets/img/nav/bell.svg';
    ...
    <nav className='navbar navbar-expand-lg navbar-light fixed-top'>
      <div className='container-fluid'>
        ...
        <div className='collapse navbar-collapse' id='navbarCollapse'>
          <ul className='navbar-nav mx-auto middle'>
            <li className='nav-item ml-5' id='mar-off'>
              <a href='#?' className='nav-link smooth-scroll active'>
                <svg
                  viewBox='0 0 28 28'
            ...
            <li className='nav-item'>
              <a href='#service' className='nav-link smooth-scroll'>
                <svg
                  viewBox='0 0 28 28'
            ...
            <li className='nav-item'>
              <a href='#story' className='nav-link smooth-scroll'>
                <svg
                  viewBox='0 0 28 28'
                  className='icon-box-con--icon'
                  height={28}
            ...
            <li className='nav-item'>
              <a href='#skill' className='nav-link smooth-scroll'>
                <svg
                  viewBox='0 0 28 28'
                  className='icon-box-con--icon'
                  fill='currentColor'
            ...
            <li className='nav-item'>
              <a href='#portfolio' className='nav-link smooth-scroll'>
                <svg
                  viewBox='0 0 28 28'
                  className='icon-box-con--icon'
                  height={28}
            ...
            <div className='rig'>
              <div className=''>
                ...
                <svg
                  viewBox='0 0 28 28'
                  alt=''
                  className='user-select--messenger-box--icon'
                  height={20}
                  width={20}
                  style={{ userSelect: 'auto' }}
                >
                ...
                <svg
                  viewBox='0 0 28 28'
                  alt=''
                  className='user-select--notification--icon'
                  height={20}
                  width={20}
                >
                ...
                <img src={ProfilePic} alt='' className='pro-pic' />
              </div>
            </div>
          </ul>
        </div>
